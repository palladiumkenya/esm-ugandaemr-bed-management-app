...
import EditBedForm from "../../bed-administration/edit-bed-form.component";
import NewBedForm from "../../bed-administration/new-bed-form.component";
import { InitialData } from "../../types";

const CompartmentAdministrationTable: React.FC = () => {
  const { t } = useTranslation();
  const headerTitle = t("wardAllocation", "Compartment Allocation");
  ...
  if ((isBedDataLoading || isLoading) && !wardsGroupedByLocations.length) {
    return (
      <>
        <Header route="Compartment Allocation" />
