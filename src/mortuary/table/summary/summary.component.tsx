...
import { MortuaryHeader } from "../../components/header/mortuary-header.component";

type RouteParams = { location: string };

const MortuaryWithCompartment: React.FC = () => {
  ...
  return (
    <>
      <MortuaryHeader
        title={t("summaryCompartment", "Summary")}
      />
      {isLoading && (
...
export default MortuaryWithCompartment;
